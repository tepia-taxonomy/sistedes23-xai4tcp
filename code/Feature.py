########################################################################
# This file is a copy of the script linked above, from external authors
# https://github.com/Ahmadreza-SY/TCP-CI/blob/main/src/python/feature_extractor/feature.py
